...
sigmamt{1}=[0 0 0; 0 0 0; 0 0 -33.92]; % global total stress
if senn==2
    sigmamt{1}=[0 0 0; 0 0 0; 0 0 -44.65]; % global total stress
end
if senn==3
        sigmamt{1}=[0 0 0; 0 0 0; 0 0 -54.52]; % global total stress
end
